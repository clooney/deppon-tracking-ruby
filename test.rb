...
postData = {"tracking_number":"9960945652"}
tracker = Trackingmore.new()
...
postData = {"tracking_number":"9960945652","carrier_code":"deppon","title":"4PX page","customer_name":"trackingmore user","customer_email":"service@trackingmore.com","order_id":"#123","order_create_time":"2018/09/08 16:51","destination_code":"US","tracking_ship_date":"20180908","tracking_postal_code":"12201","lang":"en","logistics_channel":"API TEST"}
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
...
=begin
url="http://api.trackingmore.com/v2/trackings/get?page=1&limit=100&created_at_min=&created_at_max=&update_time_min=&update_time_max=&order_created_time_min=&order_created_time_max=&numbers=9960945652&orders=&lang=en"
postData = ""
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"GET")
puts "Response #{res.code} #{res.message}: #{res.body}"
...
=begin
url="http://api.trackingmore.com/v2/trackings/deppon/9960945652/en"
postData = ""
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"GET")
puts "Response #{res.code} #{res.message}: #{res.body}"
...
=begin
url="http://api.trackingmore.com/v2/trackings/deppon/9960945652"
...
postData = {"tracking_number": "9960945652","carrier_code":"deppon","destination_code": "US","tracking_ship_date":"20180908","tracking_postal_code":"12201","specialNumberDestination":"UK","order":"#123","order_create_time":"2018/09/08 16:51","lang":"en"}
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = {"tracking_number":"9960945652","carrier_code":"deppon","update_carrier_code":"china-ems"}
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = [{"carrier_code":"deppon","destination":"US","original":"CN"},{"carrier_code":"china-ems","destination":"US","original":"CN"}]
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = [{"tracking_number":"9960945652","carrier_code":"deppon"},{"tracking_number":"LZ448865302CN","carrier_code":"china-ems"}]
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData =[{"tracking_number":"9960945652","carrier_code":"deppon","title":"4PX page","customer_name":"trackingmore user","customer_email":"service@trackingmore.com","order_id":"#123","destination_code":"US","status":"7","logistics_channel":"API TEST"},{"tracking_number":"9960945652","carrier_code":"china-ems","title":"4PX page","customer_name":"trackingmore user","customer_email":"service@trackingmore.com","order_id":"#123","destination_code":"US","status":"7","logistics_channel":"API TEST"}]
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end